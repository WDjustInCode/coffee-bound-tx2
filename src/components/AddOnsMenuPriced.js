...
const AddOnsMenu = ({ menuItem }) => (
  <div className="menuColumns columns is-multiline pt-0 px-0 mt-5" style={{zIndex: -1}}>
    <span id="addOnsMenu" className="anchors"></span>
    <h1 className="column is-12 has-text-black has-text-centered pb-1 has-text-weight-bold is-size-4">ADD ONS/EXTRAS</h1>
    {menuItem.map((item) => {
      return (
          ...
          <div className="columns is-mobile">
            ...
            <div className="column">
              <div className="columns is-centered is-mobile">
                ...
                <p className="column is-8 has-text-black has-text-weight-semibold px-0">{item.title}</p>
